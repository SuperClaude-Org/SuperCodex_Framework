# SuperCodex PyPI Publishing Guide

SuperCodex Framework is published to PyPI as a Python package with automated CI/CD workflows for testing, validation, and release management. The publishing process includes comprehensive testing, security validation, and multi-platform compatibility verification.
...
- **Primary**: PyPI (pip install SuperCodex)
...
# Development version
pip install git+https://github.com/SuperCodex-Org/SuperCodex_Framework.git

# Specific version
pip install SuperCodex==4.0.0
```
...
- Project maintainer access to SuperCodex package
...
```bash
# Generate PyPI API token with SuperCodex package scope
# Add to GitHub repository secrets as PYPI_API_TOKEN
# Token format: pypi-AgEIcHl... (scoped to SuperCodex package)
```
...
pip install dist/SuperCodex-*.whl
```
...
**Package Name**: `SuperCodex`
**Current Version**: 4.0.0 (Major release with v4 architecture)
**PyPI URL**: https://pypi.org/project/SuperCodex/
**GitHub URL**: https://github.com/SuperCodex-Org/SuperCodex_Framework

**Entry Points:**
```python
[console_scripts]
SuperCodex = superclaude.cli:main
...
**Metadata:**
- **Author**: SuperCodex Organization
- **License**: MIT License
- **Python Requires**: >=3.8
- **Classifiers**: Development Status :: 5 - Production/Stable
- **Keywords**: codex, ai, development, automation, mcp, agents
...
**Wheel Distribution:**
```
SuperCodex-4.0.0-py3-none-any.whl
├── superclaude/                    # Compiled package code
├── SuperCodex-4.0.0.dist-info/   # Package metadata
...
twine check dist/*
tar -tzf dist/SuperCodex-*.tar.gz | head -20
...
pip install --index-url https://test.pypi.org/simple/ SuperCodex
...
**Integration Testing:**
```bash
# Test with real Codex Code environment
codex --version
SuperCodex install --components core
# Verify slash commands work: SuperCodex help
```
...
# Check: https://pypi.org/project/SuperCodex/
...
# Issue: "Command 'SuperCodex' not found"
# Solution: Check PATH and entry points
pip show -f SuperCodex | grep console_scripts
which SuperCodex
```
...
- [ ] Entry points functional (`SuperCodex --version`)
...
- [ ] Integration testing with Codex Code environment
...
PYPI_API_TOKEN          # PyPI publishing token (scoped to SuperCodex)
...
- **Project Scope**: Limited to SuperCodex package only
...
curl -s https://pypi.org/pypi/SuperCodex/json | jq '.info.version'

# 2. Test installation from PyPI
pip install SuperCodex==4.0.1
SuperCodex --version
...
**Primary Maintainers:**
- **GitHub**: @SuperCodex-Org maintainer team
- **Issues**: https://github.com/SuperCodex-Org/SuperCodex_Framework/issues
